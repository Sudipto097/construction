...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form method="post" class="dropzone" action="{{route('Add-Choose')}}"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="question_1"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="question_2"
                                       id="example-text-input">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="question_3"
                                       id="example-text-input">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="question_4"
                                       id="example-text-input">
                            </div>
                        </div>
                        <div class="mb-3 row">
